...
def compare_colmap_reconstructions_horn(path1, path2):
    ...
    loss = horn_loss(R, t, scale, points1, points2)
...
if __name__ == "__main__":
    ...
    loss, R, t, scale = compare_colmap_reconstructions_horn(path_gt, path_pred_mast3r)
    print(f"Horn loss mast3r: {loss}")
    loss, R, t, scale = compare_colmap_reconstructions_horn(path_gt, path_pred_vggt)
    print(f"Horn loss vggt: {loss}")
    loss, R, t, scale = compare_colmap_reconstructions_horn(path_pred_mast3r, path_pred_vggt)
    print(f"Horn loss vggt vs mast3r: {loss}")